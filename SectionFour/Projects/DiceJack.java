...
public class DiceJack {
    public static void main(String[] args) {
        ...
        if (num1 < 1 || num2 < 1 || num3 < 1) {
            System.out.println("Number can not be less than one. Shutting Down...");
            System.exit(0);
        }

        if (num1 > 6 || num2 > 6 || num3 > 6) {
            System.out.println("Number can not be greater than six Shutting Down...");
            System.exit(0);
        }
        ...
        System.out.println("The sum of the numbers I rolled was: " + sumOfDiceRolls + ". The sum of Numbers you rolled is: " + sumOfNumbers);   
